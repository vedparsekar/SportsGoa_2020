			...
			<nav id="sidebar">
	  		...
	  		<div class="img bg-wrap text-center py-4">
	  			<div class="user-logo">
	  				...
	  				<h4 style="font-size: 16px;color:white"><?php echo $subuser_id?></h4>
	  			</div>
	  		</div>
        <ul class="list-unstyled components mb-5">
          <li>
            <a href="subscriber_homepage.php?id=<?php echo $subuser_id?>"><span class="fa fa-home mr-3"></span> Your Events</a>
          </li>
          <li>
            <a href="event_home.php?event_id=<?php echo $event_id; ?>$id=<?php echo $subuser_id?>"><span class="fa fa-home mr-3"></span>Event Home</a>
          </li>
          <li>
            <a href="view_fixture.php?event_id=<?php echo $event_id; ?>&id=<?php echo $subuser_id?>"><span class="fa fa-home mr-3"></span>Fixture</a>
          </li>
          <li>
