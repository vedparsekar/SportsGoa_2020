      ...
      <nav id="sidebar">
        ...
        <div class="img bg-wrap text-center py-4">
          <div class="user-logo">
            ...
            <h4 style="font-size: 16px;"><?php $subuser_id?></h4>
          </div>
        </div>
        <ul class="list-unstyled components mb-5">
          <li>
            <a href="subuser_homepage.php?"><span class="fa fa-home mr-3"></span> Your Events</a>
          </li>
          <li class="active">
          ...
          <div class="container" style="background-color: #141414;background-size: 600px 480px;text-align: center;display: inline-block;width: 800px;margin-top: -45px; ">
            ...
            <form method="POST" id="signup-form" class="signup-form">
              ...
              <fieldset style="padding-top: 30px;">
                <div class="fieldset-content1">
                    <input type="text" value="<?php echo $subuser_id; ?>" name="subuser_id" id="subuser_id" hidden>
            ...
            <fieldset>
                ...
                <div class="fieldset-content1"  style="padding-top: 30px;">
                    ...
                    <div class="form-group">
                        <input type="text" value="<?php echo $subuser_id; ?>" name="subuser_id" id="subuser_id" hidden>
                        <label for="subuser_id" class="form-label fm-lb">Sub-User ID </label>
                        <input type="text" value="<?php echo $subuser_id; ?>" name="event_name" id="event_name" readonly />
                    </div>
                    <!--
  ...
  if(confirm("Are you sure you want to delete this Post?"))
  {
   $.ajax({
     ...
     success: function()
     {
      ...
      window.location = "subuser_homepage.php?id=<?php echo $subuser_id;?>";
     }
    });
  }
  return false;
