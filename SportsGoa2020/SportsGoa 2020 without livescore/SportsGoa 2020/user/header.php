...
<body>
	...
	if (isset($_POST['signup'])) {
		if ($_POST['password'] != $_POST['cpassword']) {
			...
			//$password=md5($pass);
			$sql = "INSERT INTO  users(user_name,name,email,password,type) VALUES(:user_name,:name,:email,:password,'User')";
			$query = $dbh->prepare($sql);
		...
		<form class="reg-modal-content" action="homepage.php" method="post">
			...
			<div class="reg-contact-details">
					...
					<div>
						...
						<input type="text" placeholder="For eg. xyz@123" name="user_name">
					</div>
				</div>
						...
						<nav>
						  <ul>
							...
							<li class="dropdown">
								...
								<li>
											<a href="tournaments.php?cat=<?php echo "cricket"; ?>&type=<?php echo "university"; ?>&id=<?php echo $_SESSION['uname'];?>"><span>Cricket</span>
											</a>
										</li>
	                                     <li>
	                                     	<a href="tournaments.php?cat=<?php echo "football"; ?>&type=<?php echo "university"; ?>&id=<?php echo $_SESSION['uname'];?>"><span >Football</span></a>
	                                     </li>
	                                     <li>
	                                     	<a href="tournaments.php?cat=<?php echo "volleyball"; ?>&type=<?php echo "university"; ?>&id=<?php echo $_SESSION['uname'];?>"><span >Volleyball</span></a>
	                                     </li>
	                                     <li>
                                     		<a href="tournaments.php?cat=<?php echo "hockey"; ?>&type=<?php echo "university"; ?>&id=<?php echo $_SESSION['uname'];?>"><span >Hockey</span></a>
                                     	</li>
                                     </ul>
                                </li>   
							    ...
							    <li class="dropdown">
                                     ...
                                     <ul class="dropdown-menu">
	                                     <li>
	                                     	<a href="tournaments.php?cat=<?php echo "cricket"; ?>&type=<?php echo "local"; ?>&id=<?php echo $_SESSION['uname'];?>"><span>Cricket</span></a>
	                                     </li>
	                                     <li>
	                                     	<a href="tournaments.php?cat=<?php echo "football"; ?>&type=<?php echo "local"; ?>&id=<?php echo $_SESSION['uname'];?>"><span >Football</span></a>
	                                     </li>
	                                     <li>
	                                     	<a href="tournaments.php?cat=<?php echo "volleyball"; ?>&type=<?php echo "local"; ?>&id=<?php echo $_SESSION['uname'];?>"><span >Volleyball</span></a>
	                                     </li>
	                                     <li>
	                                     	<a href="tournaments.php?cat=<?php echo "hockey"; ?>&type=<?php echo "local"; ?>&id=<?php echo $_SESSION['uname'];?>"><span >Hockey</span></a>
	                                     </li>
                                     </ul>
                                 </li>
