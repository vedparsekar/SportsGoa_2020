  ...
  <body>
    ...
    ?>
      ...
      <?php
        ...
        { 
        echo"<div style='margin:0px 0px 10px 0px;width:600px;margin-left:150px;' >
             <div style='background-color:black;padding:8px;font-size:20px;color:white;border:1px solid black;text-transform:uppercase;background-color:bla;'>
             <b><center>".$row['team1']."  V/S  ".$row['team2']."</center></b></div>

            <div style='padding:8px;font-size:13px;background:white;'>
              <div style='font-size:12pt;text-transform:capitalize;color:black;float:left;background:#eee;'>
              <center>Date:".$row['t_date']."</center></div>  

              <div style='font-size:12pt;text-transform:capitalize;color:black;float:left;margin-left:350px;background:#eee;'>
              time: ".$row['t_time']." </div><br>

              <div style='font-size:12pt;text-transform:capitalize;color:black;background:#eee;'>
