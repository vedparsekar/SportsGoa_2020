...
<head>
  ...
  <script type="text/javascript">
      function getData(ecategory,etype, divid){
          $.ajax({
              url: 'load_events.php?id=<?php echo $subscriber_id;?>',
        ...
        <div class="modal-dialog">
          ...
          <div class="container" style="background: url('../content/multi_step/images/nike.png');background-size: 600px 480px;height:600px;text-align: center;display: inline-block;width: 800px;margin-top: -45px; ">
                    ...
                    <div class="form-select">
                        ...
                        <div class="form-select-item">
                          <?php
                            ...
                            $queryii="select subuser_id,name from sub_users";
            ...
            <div style="align-content: center;margin-top: -15px;">
              <button type="submit" style="" class="reg-btn" value="Signup" name="insert_post" id="insert_post">Submit Details</button>
            </div>
            </form>
        </div>
      </div>
          ...
          if ($('#event_name').val() == "") {
              ...
              $.ajax({
                  ...
                  success: function(data) {
                      ...
                      window.location = "subscriber_homepage.php?id=<?php echo $subscriber_id;?>";
                  }
              });
          }
      });
