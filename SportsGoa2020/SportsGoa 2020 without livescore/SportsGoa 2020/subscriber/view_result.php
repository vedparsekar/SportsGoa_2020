			...
			<nav id="sidebar">
	  		...
	  		<div class="img bg-wrap text-center py-4">
	  			<div class="user-logo">
	  				...
	  				<h4 style="font-size: 16px;"><?php $subscriber_id;?></h4>
	  			</div>
	  		</div>
        <ul class="list-unstyled components mb-5">
          <li>
            <a href="subscriber_homepage.php?id=<?php $subscriber_id;?>"><span class="fa fa-home mr-3"></span> Your Events</a>
          </li>
          <li>
            <a href="event_home.php?event_id=<?php echo $event_id; ?>&id=<?php $subscriber_id;?>"><span class="fa fa-home mr-3"></span>Event Home</a>
          </li>
          <li>
            <a href="view_fixture.php?event_id=<?php echo $event_id; ?>&id=<?php $subscriber_id;?>"><span class="fa fa-trophy mr-3"></span>View Fixture</a>
          </li>
          <li class="active">
          ...
          <li>
            ...
            <ul class="list-unstyled components dropdownbut">
                <li>
                    <a href="view_news.php?event_id=<?php echo $event_id; ?>&id=<?php $subscriber_id;?>"><span class="fa fa-car mr-3"></span> View News Article</a>
                </li>
                <li>
                  <a href="add_news.php?event_id=<?php echo $event_id; ?>&id=<?php $subscriber_id;?>"><span class="fa fa-car mr-3"></span> Add News Article</a>
                </li>
              </ul>
          </li>
        </ul>
