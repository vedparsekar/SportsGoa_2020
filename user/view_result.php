    ...
    <div id="content" class="p-4 p-md-5 pt-5">
      ...
      if (mysql_num_rows($res) > 0) {
        while ($row = mysql_fetch_array($res)) {
          ...
          <div class='result-score-info' align='center'>" . $row['team1'] . "  " . $row['team1_score'] . "  
          ...
          <br><br><br>
          <div class='result-score-desc' align='center'> " . $row['description'] . "  </div>
                   </div>
              </div>
          <br>    
        ...
        <div class='result-container' >
               ...
               <div class='result-score'>
        <div class='result-score-info' align='center'> 
        ...
        <div class='result-score-desc' align='center'> " . $description . "  </div>
                 </div>
            </div>
        <br>    
        ...
        <div class='result-container' >
               ...
               <div class='result-score'>
        <div class='result-score-info' align='center'>" . $row['team1'] . "  " . $row['team1_score'] . " </div>

        <br>

        <div class='result-score-info' align='center'>" . $row['team2_score'] . "  " . $row['team2'] . "</div>
        <br>
        <div class='result-score-desc' align='center'> " . $row['description'] . "  </div>
                 </div>
            </div>
